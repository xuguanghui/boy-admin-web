...
Formatter = (function(_super) {
  ...
  Formatter.prototype._init = function() {
    ...
    this._allowedAttributes = {
      img: ['src', 'alt', 'width', 'height', 'domain-image-src', 'data-image-size', 'domain-image-name', 'domain-non-image'],
      a: ['href', 'target'],
      font: ['color'],
      pre: ['domain-lang', 'class'],
      p: ['domain-indent'],
      h1: ['domain-indent'],
      h2: ['domain-indent'],
      h3: ['domain-indent'],
...
Util = (function(_super) {
  ...
  Util.prototype.indent = function() {
    ...
    if ($blockEl.is('pre')) {
      ...
      indentLevel = (_ref = $blockEl.attr('domain-indent')) != null ? _ref : 0;
      indentLevel = indentLevel * 1 + 1;
      if (indentLevel > 10) {
        indentLevel = 10;
      }
      $blockEl.attr('domain-indent', indentLevel);
...
ColorButton = (function(_super) {
  ...
  ColorButton.prototype.renderMenu = function() {
    $('<ul class="color-list">\n  <li><a href="javascript:;" class="font-color font-color-1" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-2" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-3" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-4" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-5" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-6" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-7" domain-color=""></a></li>\n  <li><a href="javascript:;" class="font-color font-color-default" domain-color=""></a></li>\n</ul>').appendTo(this.menuWrapper);
...
CodePopover = (function(_super) {
  ...
  CodePopover.prototype.render = function() {
    ...
    return this.selectEl.on('change', (function(_this) {
      return function(e) {
        ...
        _this.target.removeClass().removeAttr('domain-lang');
        if (_this.lang !== -1) {
          _this.target.addClass('lang-' + _this.lang);
          _this.target.attr('domain-lang', _this.lang);
        }
        if (selected) {
  ...
  CodePopover.prototype.show = function() {
    ...
    this.lang = this.target.attr('domain-lang');
    if (this.lang != null) {
...
ImageButton = (function(_super) {
  ...
  ImageButton.prototype._init = function() {
    ...
    this.editor.body.on('click', 'img:not([domain-non-image])', (function(_this) {
      return function(e) {
        var $img, range;
        $img = $(e.currentTarget);
        range = document.createRange();
    ...
    this.editor.body.on('mouseup', 'img:not([domain-non-image])', (function(_this) {
      return function(e) {
        return false;
      };
    })(this));
    this.editor.on('selectionchanged.image', (function(_this) {
      return function() {
        ...
        if ($contents.length === 1 && $contents.is('img:not([domain-non-image])')) {
...
TableButton = (function(_super) {
  ...
  TableButton.prototype._initShortcuts = function() {
    this.editor.inputManager.addShortcut('ctrl+alt+up', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[domain-param=insertRowAbove]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+down', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[domain-param=insertRowBelow]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+left', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[domain-param=insertColLeft]').click();
        return false;
      };
    })(this));
    return this.editor.inputManager.addShortcut('ctrl+alt+right', (function(_this) {
      return function(e) {
        _this.editMenu.find('.menu-item[domain-param=insertColRight]').click();
        return false;
      };
    })(this));
  };
  ...
  TableButton.prototype.renderMenu = function() {
    $("<div class=\"menu-create-table\">\n</div>\n<div class=\"menu-edit-table\">\n  <ul>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"deleteRow\"><span>" + (this._t('deleteRow')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"insertRowAbove\"><span>" + (this._t('insertRowAbove')) + " ( Ctrl + Alt + ↑ )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"insertRowBelow\"><span>" + (this._t('insertRowBelow')) + " ( Ctrl + Alt + ↓ )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"deleteCol\"><span>" + (this._t('deleteColumn')) + "</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"insertColLeft\"><span>" + (this._t('insertColumnLeft')) + " ( Ctrl + Alt + ← )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"insertColRight\"><span>" + (this._t('insertColumnRight')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" domain-param=\"deleteTable\"><span>" + (this._t('deleteTable')) + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper);
