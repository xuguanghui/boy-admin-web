...
(function (api) {
    ...
    var defaults = {
        ...
        selectors: {
            ...
            labels: '[domain-player] .sr-only, label .sr-only',
            buttons: {
                seek: '[domain-player="seek"]',
                play: '[domain-player="play"]',
                pause: '[domain-player="pause"]',
                restart: '[domain-player="restart"]',
                rewind: '[domain-player="rewind"]',
                forward: '[domain-player="fast-forward"]',
                mute: '[domain-player="mute"]',
                volume: '[domain-player="volume"]',
                captions: '[domain-player="captions"]',
                fullscreen: '[domain-player="fullscreen"]'
            },
            progress: {
    ...
    function _buildControls() {
        ...
        '<div class="player-controls">',
            '<div class="player-progress">',
                ...
                '<input id="seek{id}" class="player-progress-seek" type="range" min="0" max="100" step="0.5" value="0" domain-player="seek">',
        ...
        if (_inArray(config.controls, 'restart')) {
            html.push(
                '<button type="button" domain-player="restart">',
        ...
        if (_inArray(config.controls, 'rewind')) {
            html.push(
                '<button type="button" domain-player="rewind">',
        ...
        if (_inArray(config.controls, 'fast-forward')) {
            html.push(
                '<button type="button" domain-player="fast-forward">',
        ...
        if (_inArray(config.controls, 'mute')) {
            html.push(
                '<button type="button" domain-player="mute">',
        ...
        if (_inArray(config.controls, 'volume')) {
            html.push(
                ...
                '<input id="volume{id}" class="player-volume" type="range" min="0" max="10" value="5" domain-player="volume">'
            );
        }
        ...
        if (_inArray(config.controls, 'captions')) {
            html.push(
                '<button type="button" domain-player="captions">',
        ...
        if (_inArray(config.controls, 'fullscreen')) {
            html.push(
                '<button type="button" domain-player="fullscreen">',
    ...
    function Plyr(container) {
        ...
        function _setupMedia() {
            ...
            if (player.type == 'youtube') {
                _setupYouTube(player.media.getAttribute('domain-video-id'));
            }
        ...
        function _init() {
            ...
            if (tagName === 'div') {
                player.type = player.media.getAttribute('domain-type');
            } else {
                player.type = tagName;
            }
